...
float *translateLeftAngles(float a[]) {
  a[0] = a[0] * (-1) + 97 * M_PI / 180;
  a[1] = a[1] * (-1) + M_PI * 90 / 180;
  a[2] = a[2] + 93 * M_PI / 180;
  a[3] = a[3] + 32 * M_PI / 180;
  a[4] = a[4] + 95 * M_PI / 180;
  a[5] = a[5] * (-1) + 95 * M_PI / 180;
...
void loop() {
  ...
  float a[] = {0.000000, 0.001925, -0.749515, 1.463467, -0.713951, -0.001925};
  a[0] = a[0] * (-1) + 97 * M_PI / 180;
  a[1] = a[1] * (-1) + M_PI * 90 / 180;
  a[2] = a[2] + 93 * M_PI / 180;
  a[3] = a[3] + 32 * M_PI / 180;
  a[4] = a[4] * (-1) + 95 * M_PI / 180;
  a[5] = a[5] * (-1) + 95 * M_PI / 180;
